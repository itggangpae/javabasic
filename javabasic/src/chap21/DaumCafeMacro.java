...
class SeleniumDaum {
	...
	public void crawl() {
		try {
			...
			driver.findElement(By.xpath("//*[@id=\"memoForm\"]/div/table/tbody/tr[1]/td[1]/div/textarea")).sendKeys("더조은에서 연습");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id=\"memoForm\"]/div/table/tbody/tr[1]/td[2]/a[1]")).click();
