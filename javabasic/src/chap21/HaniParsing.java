...
class HaniHandler extends DefaultHandler {
	// 파싱할 데이터를 저장할 객체
	...
	public HaniHandler(List<Map<String, String>> list) {
		this.list = list;
	}
...
public class HaniParsing {
	public static void main(String[] args) {
		try {
			...
			// 파싱 수행을 위임
			parser.parse("http://www.hani.co.kr/rss/sports/", new HaniHandler(list));
			//데이터 출력
